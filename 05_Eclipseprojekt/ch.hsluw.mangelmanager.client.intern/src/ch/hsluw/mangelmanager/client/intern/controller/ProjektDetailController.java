...
public class ProjektDetailController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		for (Arbeitstyp arbeitstyp : FXCollections.observableArrayList(client
				.getAllArbeitstyp())) {
	...
	private void setCellValueFactoryTblBauleiter() {
		...
		colProjektBauleiterId
				.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ProjektGuMitarbeiter, String>, ObservableValue<String>>() {
		...
		colProjektBauleiterStartdatum
				.setCellValueFactory(new Callback<CellDataFeatures<ProjektGuMitarbeiter, String>, ObservableValue<String>>() {
					public ObservableValue<String> call(
							CellDataFeatures<ProjektGuMitarbeiter, String> p) {
	...
	private void setCellValueFactoryTblMeldung() {
		colProjektMeldungId
				.setCellValueFactory(new PropertyValueFactory<Meldung, String>(
						"id"));
	...
	private void setCellValueFactoryTblUnternehmen() {
		colProjektUnternehmenId
				.setCellValueFactory(new PropertyValueFactory<Subunternehmen, String>(
						"id"));
		colProjektUnternehmenName
				.setCellValueFactory(new PropertyValueFactory<Subunternehmen, String>(
						"name"));
		colProjektUnternehmenStrasse
				.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Subunternehmen, String>, ObservableValue<String>>() {
					public ObservableValue<String> call(
							TableColumn.CellDataFeatures<Subunternehmen, String> p) {
						return new SimpleStringProperty(p.getValue()
